                    ...
                    <div class="flex">
                        <div class="py-1">
                            <svg class="h-6 w-6 text-red-500 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.928-.833-2.698 0L4.268 16.5c-.77.833.192 2.5 1.732 2.5z"/>
                            </svg>
                        </div>
                        <div>
                            <p class="font-bold">Configuration Error</p>
                            <p class="text-sm">{{ $error }}</p>
                            <p class="text-xs mt-1">Please check your .env file for SHOPIFY_STORE_DOMAIN and SHOPIFY_ADMIN_TOKEN</p>
                        </div>
                    </div>
                </div>
            @endif
